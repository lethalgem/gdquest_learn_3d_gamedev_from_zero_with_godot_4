...
## Create a file res://addons/gdpractice/practice_solutions/metadata.gd in your project and append PracticeMetadata objects to the [member list] property to define and register practices in your project.
@tool
extends Node
