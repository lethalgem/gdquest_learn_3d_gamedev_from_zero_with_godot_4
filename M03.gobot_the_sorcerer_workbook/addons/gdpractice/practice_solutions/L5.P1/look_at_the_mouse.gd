...
var _world_plane := Plane(Vector3.UP) # var _world_plane
...
func _physics_process(delta: float) -> void:
	...
	world_mouse_position = _world_plane.intersects_ray(_camera_3d.global_position, mouse_ray) # world_mouse_position = null
